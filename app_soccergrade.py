...
def generate_tactics():
    ...
    prompt_instruction = f"""Provide the key characteristics and skills required for each position in a {format_type} soccer lineup. 
    Return ONLY a valid JSON list of objects representing a dataframe with columns 'Position' and 'Description'. 
    Format Example: [{{"Position": "Goalkeeper (GK)", "Description": "Exceptional shot-stopping reflexes and vocal organization."}}]"""
